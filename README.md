...
|---|---|---|
| rules | `.claude/rules/` | `doc-organization`, `critical-thinking`, `file-reading`, `conversational-output`, `claude-md-standards`, `agents-md-standards`, `skill-md-standards`, `rule-writing-standards`, `subagent-standards`, `wiki-tier` |
...
| Codex surface | generated by `render_codex.py` | `AGENTS.md`, `.agents/skills/`, `.codex/agents/` |
