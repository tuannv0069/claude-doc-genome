...
- `./portable/guide/` — bug-report-format.md, capability-packaging.md, doc-system-mechanics.md, five-why.md, fix-impact-analysis.md, lesson-capture.md, markdown.md, mermaid.md, decision-journal.md, orchestration-policy.md, review-checklist-method.md, role-selection.md, rule-health.md, task-planning.md, verification-gate-design.md, worktree.md (deploy to `.agent-workspace/guide/general/`)
