...
- `.claude/rules/doc-organization.md` — generated SKILL.md MUST NOT inline substantive code rule; reference guide §ID instead
...
- [ ] state / staging paths use layout `.agent-workspace/tasks/{prefix}/sessions/{JOB_KEY}/{SESSION}/...`
