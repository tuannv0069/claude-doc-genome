...
| .gitignore | `.agent-workspace/tasks/` required |
...
6. layout: `.agent-workspace/tasks/{prefix}/sessions/{JOB_KEY}/{SESSION}/{state.json,plan.json,staging/{scope/}/,artifacts/,logs/}`
