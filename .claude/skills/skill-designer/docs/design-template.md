...
- staging without JOB_KEY segment (flat `.agent-workspace/tasks/{prefix}/state-*` layout)
...
- Plan file: .agent-workspace/tasks/<prefix>/sessions/<JOB_KEY>/<SESSION>/plan.json
