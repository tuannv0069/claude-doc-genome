...
- flat layout `.agent-workspace/tasks/{prefix}/state-${SESSION}.json` (loses task isolation; collides cross-function)
...
- staging/state under `.agent-workspace/tasks/{prefix}/sessions/{JOB_KEY}/{SESSION}/`
...
- session root: `.agent-workspace/tasks/{prefix}/sessions/{JOB_KEY}/{SESSION}/`
...
- latest pointer: `.agent-workspace/tasks/{prefix}/sessions/{JOB_KEY}/latest` (symlink → SESSION)
- locks dir: `.agent-workspace/tasks/{prefix}/locks/` (cross-session)
- archive dir: `.agent-workspace/tasks/{prefix}/archive/{JOB_KEY}/{SESSION}/`
...
❌ output: `.agent-workspace/tasks/my-skill/state-${SESSION}.json` (flat; both runs collide visually, hard to debug)
✅ output: `.agent-workspace/tasks/my-skill/sessions/REPORT-A/{SESSION}/state.json` + `.agent-workspace/tasks/my-skill/sessions/REPORT-B/{SESSION}/state.json`
</example>
...
❌ output: `allowed_prefixes: ['.agent-workspace/tasks/']`
✅ output: `allowed_prefixes: ['.agent-workspace/tasks/rptw/']`
</example>
...
✅ output:
```
.agent-workspace/tasks/my-skill/
├── sessions/REPORT-A/
...
8. layout: `.agent-workspace/tasks/{prefix}/sessions/{JOB_KEY}/{SESSION}/{state.json,plan.json,staging/{scope/}/,artifacts/,logs/}`
